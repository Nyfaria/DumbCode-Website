  ...
  return (
    <BasicPage pageName="Genetics Guide" pageDesc="This guide shows you the genetics generated by different mobs.">
      <div className="flex flex-row">
        <div className={(indexCollapsed ? "-translate-x-full w-0" : "w-64") + " flex-shrink-0 h-[calc(100vh-3.5rem)] sticky top-4 mb-10 bg-neutral-900 overflow-visible transition-all ml-4 rounded-md"}>
          ...
          <div className="w-full h-full overflow-y-scroll dumbcode-scrollbar bg-neutral-900 rounded-lg">
            <MobGeneticsIndex />
          </div>
        </div>
...
const MobGeneticEntry = ({ geneData }: { geneData: GeneData }) => {
  ...
  return (
    <div className="mt-10 mx-2 bg-neutral-900 p-4 rounded-md">
        ...
        <div className="flex-grow flex flex-col ">
          ...
          {colourData.length !== 0 &&
            <div className="mb-2">
              ...
              <div className="flex flex-row flex-wrap w-full pr-10">
...
const MobGeneticsByDietEntry = ({ name, data }: {
  ...
  return (
    <div key={name} className="flex flex-col mt-10 mx-2 bg-neutral-900 p-4 rounded-md">
...
const MobGeneticsByGeneEntry = ({ name, data }: {
  ...
  return (
    <div key={name} className="mt-10 mx-2 bg-neutral-900 p-4 rounded-md flex flex-col">
      <a href={`#${id}`} id={id} className="text-2xl font-semibold text-white">{name}</a>
      {data.map((datum, i) => {
