export const ModelerDesc = (props: any) => {
    return (
        <p {...props}>
            ...
            could be.
            <br /><br />
            The DumbCode Studio's Modeler is a command based modeler like Rhino, with the design of a modern modeler like Blender or Blockbench, and
...
export const TexturerDesc = (props: any) => {
    return (
        <p {...props}>
            The DumbCode Studio Texturer v2.0 is the next step towards creating a one-stop-shop for your team's Textuerers. While this tool doesn't 
            quite replace every tool that a texturer may need to create a final texture, it's very close. The texturer brings tools like on-model 
            painting that external texture tools can't cover, texture groups for creating multiple textures per model, texture layers for keeping 
            ...
            that every texturer needs to finalize their team's visuals without the need for external tools, and with the features we have planned 
            for the texturer, we believe that goal isnt too far away!
        </p>
    );
}

export const AnimatorDesc = (props: any) => {
    return (
        <p {...props}>
            This is the 3rd version of the DumbCode Studio Animator and we think we've finally nailed it. When we started the animator for our team 
            ...
            <br /><br />
            Our animator is jam packed with features like a now stackable keyframe based timeline that isn't per-cuboid. This means you can more 
            ...
            time game events with the animation events; like trigger a particle effect when a dragon has it's mouth open.
        </p>
    );
}

export const ProjectDesc = (props: any) => {
    return (
        <p {...props}>
            ...
            with the new Remote Repository features. Configure the Studio to interact directly with your team's GitHub repository to make sure that 
            your team is up-to-date with the latest and greatest versions of your project's assets.
            <br /><br />
            That's just the newest feature, how about the older features of the Project Page that have made the DumbCode Studio truly the hub for 
            your team's asset creation. From the Project page you can upload models of various formats including Tabula (.tbl), BlockBench (.bbmodel) 
